...
from adminapp.views import index, create_user, UserList, update_user, delete_user, create_category, read_categories, \
...
urlpatterns = [
    ...
    path('read_users', UserList.as_view(), name='read_users'),
